...
class StudentLevelManipulationActivity : AppCompatActivity() {
    private lateinit var binding: ActivityStudentLevelManipulationBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityStudentLevelManipulationBinding.inflate(layoutInflater)
    ...
    private fun getAdminAndLevel() {
        ...
        authViewModel.getUser().observe(this) {
            ...
            if (token == AuthPreferences.DEFAULT_VALUE) {
                ...
                if (isEditDeleteView) {
                    adminViewModel.getLevelById(id)
                }
            }
        }
        ...
        adminViewModel.identityAcademic.observe(this) { eventData ->
            eventData.getContentIfNotHandled()?.let {
                ...
                if (it.isAdded || it.isUpdated || it.isDeleted) {
                    ...
                    val level = getString(R.string.text_level)
