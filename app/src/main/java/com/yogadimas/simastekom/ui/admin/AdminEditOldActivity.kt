...
import com.yogadimas.simastekom.databinding.ActivityAdminEditOldBinding
...
class AdminEditOldActivity : AppCompatActivity(), OnOptionDialogListenerInterface {


    private lateinit var binding: ActivityAdminEditOldBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAdminEditOldBinding.inflate(layoutInflater)
    ...
    private fun displayView(it: AdminData?) {
        if (it != null) {
            ...
            val loader = ImageLoader(this@AdminEditOldActivity)
            val req = ImageRequest.Builder(this@AdminEditOldActivity)
                .data(picture)
                .target { result ->
    ...
    private fun identityPersonal(binding: ActivityAdminEditOldBinding) {
        binding.apply {

            settingViewModel.getSetting().observe(this@AdminEditOldActivity) {
            ...
            if (gender != null) {
                when (gender.lowercase()) {
                    getString(R.string.text_man).lowercase() -> inputLayoutGender.startIconDrawable =
                        ContextCompat.getDrawable(this@AdminEditOldActivity, R.drawable.z_ic_man)

                    getString(R.string.text_woman).lowercase() -> inputLayoutGender.startIconDrawable =
                        ContextCompat.getDrawable(this@AdminEditOldActivity, R.drawable.z_ic_woman)
                }
            }
