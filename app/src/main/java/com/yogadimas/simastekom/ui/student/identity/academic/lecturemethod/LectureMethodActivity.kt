package com.yogadimas.simastekom.ui.student.identity.academic.lecturemethod
...
import com.yogadimas.simastekom.databinding.ActivityLectureMethodBinding
...
class LectureMethodActivity : AppCompatActivity() {
    private lateinit var binding: ActivityLectureMethodBinding
    ...
    private val resultLauncher = registerForActivityResult(
        ...
        if (result.resultCode == LectureMethodManipulationActivity.KEY_RESULT_CODE && result.data != null) {
            val successText =
                result.data?.getStringExtra(LectureMethodManipulationActivity.KEY_EXTRA_SUCCESS)
                    .orEmpty()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityLectureMethodBinding.inflate(layoutInflater)
        ...
        binding.apply {
            ...
            searchView
                ...
                .setOnEditorActionListener { _, _, _ ->
                    ...
                    adminViewModel.searchSortLectureMethod(
            ...
            fabAdd.setOnClickListener {
                resultLauncher.launch(
                    Intent(
                        this@LectureMethodActivity,
                        LectureMethodManipulationActivity::class.java
                    )
                )
            }

            val layoutManager = LinearLayoutManager(this@LectureMethodActivity)
            rvLectureMethod.layoutManager = layoutManager
    ...
    private fun getAdminAndData() {
        ...
        authViewModel.getUser().observe(this) {
            ...
            if (token == AuthPreferences.DEFAULT_VALUE) {
                ...
                adminViewModel.getAllLectureMethods()
            }
        }
        ...
        adminViewModel.name.observe(this) { eventData ->
            eventData.getContentIfNotHandled()?.let {
                ...
                if (it.isDeleted) {
                    ...
                    val label = getString(R.string.text_label_lecture_method)
                    showAlertDialog(
    ...
    private fun setData(it: List<NameData>) {
        val adapter =  if (isFromStudent) {
            NameAdapter(object : OnItemClickManipulationCallback<NameData> {
                override fun onItemClicked(data: NameData) {
                    ...
                    val studentData = StudentData(
                        lectureMethodId = data.id,
                        lectureMethodName = data.name,
                    )
            ...
            override fun onItemClicked(data: NameData) {
                val intent = Intent(
                    ...
                    putExtra(LectureMethodManipulationActivity.KEY_EXTRA_ID, data.id)
                }
        ...
        binding.rvLectureMethod.adapter = adapter
    }
            ...
            dialog = MaterialAlertDialogBuilder(this).apply {
                ...
                if (status == STATUS_DELETED || status == STATUS_ERROR) {
                    setPositiveButton(getString(R.string.text_ok)) { _, _ ->
                        ...
                        dialog = null
                        when (status) {
                            STATUS_DELETED -> adminViewModel.deleteLectureMethod(
                                id
                            )
    ...
    private fun isVisibleAllView(boolean: Boolean) {
        binding.apply {
            ...
            if (boolean) {
                ...
                rvLectureMethod.visibility = View.VISIBLE

            } else {
                toolbar.visibility = View.INVISIBLE
                toolbar2.visibility = View.GONE
                fabAdd.visibility = View.GONE
                rvLectureMethod.visibility = View.GONE
            }
        }
    }
    ...
    private fun showMenu(v: View, menuRes: Int, sortBy: String) {
        val popup = PopupMenu(this@LectureMethodActivity, v)
    ...
    companion object {
        ...
        const val KEY_STUDENT_RESULT_CODE = 11_400
