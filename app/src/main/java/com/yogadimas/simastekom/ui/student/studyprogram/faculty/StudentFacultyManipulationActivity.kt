package com.yogadimas.simastekom.ui.student.studyprogram.faculty
...
import com.yogadimas.simastekom.databinding.ActivityStudentFacultyManipulationBinding
...
class StudentFacultyManipulationActivity : AppCompatActivity() {
    private lateinit var binding: ActivityStudentFacultyManipulationBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityStudentFacultyManipulationBinding.inflate(layoutInflater)
        ...
        binding.apply {
            ...
            viewHandle.viewFailedConnect.btnRefresh.setOnClickListener { getAdminAndFaculty() }
        }
    ...
    private fun getAdminAndFaculty() {
        buttonIsEnabled()
        ...
        authViewModel.getUser().observe(this) {
            ...
            if (token == AuthPreferences.DEFAULT_VALUE) {
                ...
                if (isEditDeleteView) {
                    adminViewModel.getFacultyById(id)
                }
            }
        }
    ...
    private fun save() {
        binding.apply {
            ...
            if (isEditDeleteView) {
                ...
                adminViewModel.addFaculty(edtCode.text.toString(), edtName.text.toString())
            }
        }
    }
