...
class StudentDegreeActivity : AppCompatActivity() {
    ...
    private val resultLauncher = registerForActivityResult(
        ...
        if (result.resultCode == StudentDegreeManipulationActivity.KEY_RESULT_CODE && result.data != null) {
            val successText =
                result.data?.getStringExtra(StudentDegreeManipulationActivity.KEY_EXTRA_SUCCESS)
                    .orEmpty()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityStudentDegreeBinding.inflate(layoutInflater)
        ...
        binding.apply {
            ...
            searchView
                ...
                .setOnEditorActionListener { _, _, _ ->
                    ...
                    adminViewModel.searchSortDegree(searchView.text.toString().trim(), null, null)
            ...
            fabAdd.setOnClickListener {
                resultLauncher.launch(
                    Intent(
                        ...
                        StudentDegreeManipulationActivity::class.java
                    )
                )
            }

            val layoutManager = LinearLayoutManager(this@StudentDegreeActivity)
            rvDegree.layoutManager = layoutManager

            viewHandle.viewFailedConnect.btnRefresh.setOnClickListener { getAdminAndDegrees() }
    ...
    private fun getAdminAndDegrees() {
        ...
        adminViewModel.identityAcademic.observe(this) { eventData ->
            eventData.getContentIfNotHandled()?.let {
                ...
                if (it.isDeleted) {
                    ...
                    val degree = getString(R.string.text_degree)
                    showAlertDialog(
    ...
    private fun setDegreeData(it: List<IdentityAcademicData>) {
            ...
            CodeNameManipulationAdapter(object : OnItemClickManipulationCallback<IdentityAcademicData> {
                override fun onItemClicked(data: IdentityAcademicData) {
                    val intent = Intent(
                        ...
                        putExtra(StudentDegreeManipulationActivity.KEY_EXTRA_ID, data.id)
                    }
        ...
        binding.rvDegree.adapter = adapter
    }
    ...
    private fun isVisibleAllView(boolean: Boolean) {
        binding.apply {
            ...
            if (boolean) {
                ...
                rvDegree.visibility = View.VISIBLE

            } else {
                toolbar.visibility = View.INVISIBLE
                toolbar2.visibility = View.GONE
                fabAdd.visibility = View.GONE
                rvDegree.visibility = View.GONE
            }
        }
    }
    ...
    private fun showMenu(v: View, menuRes: Int, sortBy: String) {
        val popup = PopupMenu(this@StudentDegreeActivity, v)
    ...
    companion object {
        ...
        const val KEY_STUDY_PROGRAM_RESULT_CODE = 10_400
