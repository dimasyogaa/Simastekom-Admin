...
import com.yogadimas.simastekom.databinding.ActivitySemesterManipulationBinding
...
class SemesterManipulationActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySemesterManipulationBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySemesterManipulationBinding.inflate(layoutInflater)
    ...
    private fun getAdminAndData() {
        ...
        authViewModel.getUser().observe(this) {
            ...
            if (token == AuthPreferences.DEFAULT_VALUE) {
                ...
                if (isEditDeleteView) {
                    adminViewModel.getSemesterById(id)
                }
            }
        }
            ...
            dialog = MaterialAlertDialogBuilder(this).apply {
                ...
                if (status == STATUS_DELETED || status == STATUS_ERROR) {
                    setPositiveButton(getString(R.string.text_ok)) { _, _ ->
                        ...
                        dialog = null
                        when (status) {
                            STATUS_DELETED -> adminViewModel.deleteSemester(id)
                            STATUS_ERROR -> {
